...
const Sidebar: React.FC<SidebarProps> = ({ activeSection, setActiveSection, onLogout, user, onBackToLanding, isOpen, onClose }) => {
  const navItems = [
    { id: StrategySection.MARKET, label: '0. Market Analysis', icon: 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2' },
    ...
    { id: StrategySection.ADVISOR, label: '7. AI Strategy Advisor', icon: 'M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z' },
    { id: StrategySection.VAULT, label: '8. Strategy Memory Vault', icon: 'M5 8h14M5 8a2 2 0 110-4h14a2 2 0 110 4M5 8v10a2 2 0 002 2h10a2 2 0 002-2V8m-9 4h4' },
  ];
  ...
  const SidebarContent = () => (
    <>
      <div className="p-8">
        ...
        <p className="text-[10px] text-slate-500 uppercase tracking-[0.2em] font-black">Architecture Suite v1.2</p>
      </div>
      ...
      <div className="p-6 border-t border-slate-800 space-y-4">
        <div className="flex items-center gap-3 px-2">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-[10px] text-slate-500 truncate uppercase tracking-widest font-black">{user.companyName || 'Lead Partner'}</p>
          </div>
        </div>

        <button 
          onClick={onLogout}
          className="w-full flex items-center justify-between gap-3 px-4 py-3 rounded-xl text-slate-500 hover:bg-red-500/10 hover:text-red-400 transition-all border border-transparent hover:border-red-500/20"
        >
